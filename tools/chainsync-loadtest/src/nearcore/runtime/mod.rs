...
use crate::nearcore::shard_tracker::{ShardTracker, TrackedConfig};

use crate::nearcore::migrations::load_migration_data;
use crate::nearcore::NearConfig;
...
mod test {
    ...
    use crate::nearcore::config::{GenesisExt, TESTING_INIT_BALANCE, TESTING_INIT_STAKE};
    use crate::nearcore::get_store_path;
    ...
    fn test_fishermen_stake() {
        ...
        let signers: Vec<_> = validators
            ...
            .map(|id| InMemorySigner::from_seed(id.clone(), KeyType::ED25519, id.as_ref()))
            .collect();
        let fishermen_stake = 3300 * crate::nearcore::NEAR_BASE + 1;
    ...
    fn test_insufficient_stake() {
        ...
        let staking_transaction2 =
            stake(2, &signers[1], &block_producers[1], 100 * crate::nearcore::NEAR_BASE);
        env.step_default(vec![staking_transaction1, staking_transaction2]);
